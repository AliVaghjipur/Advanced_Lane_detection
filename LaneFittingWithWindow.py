...
def find_lane_pixels(binary_warped):
    ...
    # Dynamic margin based on lane width (adjust the scaling factor as needed)
    lane_width = rightx_base - leftx_base
    if lane_width > 800:
        margin = 120  # Widen margin if lanes are farther apart
    elif lane_width < 400:
        margin = 80  # Narrow margin if lanes are closer together
